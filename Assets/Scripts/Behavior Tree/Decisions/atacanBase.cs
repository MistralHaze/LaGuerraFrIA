...
public class atacanBase : DecisionTreeNode
{
    public defenderConTodasLasUnidades nodeTrue;     //Nodo al que ir si se cumple la condicion establecida P ej: Me están atacando-> Me defendere
    ...
    bool cumple_condicion = true;  //Booleano del que leemos la condicion
